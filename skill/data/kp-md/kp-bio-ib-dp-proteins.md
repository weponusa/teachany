# B1 蛋白质（结构与变性） / B1 Proteins

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-proteins node_id=bio-ib-dp-proteins subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-proteins` |
| node_id | `bio-ib-dp-proteins` |
| 知识点 | B1 蛋白质（结构与变性） |
| 英文名 | B1 Proteins |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |
...
- `bio-ib-dp-carbohydrates-lipids`

...
<!-- TeachAny KP: kp_id=kp-english-ap-logical-fallacies node_id=english-ap-logical-fallacies subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-logical-fallacies` |
| node_id | `english-ap-logical-fallacies` |
| 知识点 | 逻辑谬误 |
| 英文名 | Logical fallacies |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

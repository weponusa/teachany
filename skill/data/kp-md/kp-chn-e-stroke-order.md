# 笔画与笔顺 / Strokes / Stroke Order

<!-- TeachAny KP: kp_id=kp-chn-e-stroke-order node_id=chn-e-stroke-order subject=chinese stage=elementary -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chn-e-stroke-order` |
| node_id | `chn-e-stroke-order` |
| 知识点 | 笔画与笔顺 |

# 7 平衡（Le Chatelier/Kc/酸碱） / 7 Equilibria (AS)

<!-- TeachAny KP: kp_id=kp-chem-cam-al-equilibria-as node_id=chem-cam-al-equilibria-as subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-equilibria-as` |
| node_id | `chem-cam-al-equilibria-as` |
| 知识点 | 7 平衡（Le Chatelier/Kc/酸碱） |
| 英文名 | 7 Equilibria (AS) |
| 学科 | 化学 (chemistry) |

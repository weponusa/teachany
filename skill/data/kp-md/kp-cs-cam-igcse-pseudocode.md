...
<!-- TeachAny KP: kp_id=kp-cs-cam-igcse-pseudocode node_id=cs-cam-igcse-pseudocode subject=cs stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-cam-igcse-pseudocode` |
| node_id | `cs-cam-igcse-pseudocode` |
| 知识点 | 伪代码 |
| 英文名 | Pseudocode |
| 学科 | 计算机科学 (cs) |

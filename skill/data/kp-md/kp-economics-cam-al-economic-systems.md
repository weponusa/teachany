# 经济体制 / Economic systems

<!-- TeachAny KP: kp_id=kp-economics-cam-al-economic-systems node_id=economics-cam-al-economic-systems subject=economics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-economics-cam-al-economic-systems` |

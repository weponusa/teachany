...
<!-- TeachAny KP: kp_id=kp-biology-cam-igcse-photosynthesis-igc node_id=biology-cam-igcse-photosynthesis-igc subject=biology stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-igcse-photosynthesis-igc` |
| node_id | `biology-cam-igcse-photosynthesis-igc` |
| 知识点 | 光合作用 |
| 英文名 | Photosynthesis |
| 学科 | 生物 (biology) |

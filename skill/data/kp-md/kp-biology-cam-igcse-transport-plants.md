...
<!-- TeachAny KP: kp_id=kp-biology-cam-igcse-transport-plants node_id=biology-cam-igcse-transport-plants subject=biology stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-igcse-transport-plants` |
| node_id | `biology-cam-igcse-transport-plants` |
| 知识点 | 植物运输 |
...
- `biology-cam-igcse-plant-nutrition`

## 课标摘要

2 State that water diffuses through partially permeable membranes by osmosis；3 State that water moves into and out of cells by osmosis through the cell membrane；7 Describe osmosis as the net movement of water molecules from a region of higher water potential (dilute solution) to a region of lower water potential (concentrated solution), through a partially permeable membrane

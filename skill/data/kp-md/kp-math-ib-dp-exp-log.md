# 指数与对数（换底/方程） / Exponents and logarithms

<!-- TeachAny KP: kp_id=kp-math-ib-dp-exp-log node_id=math-ib-dp-exp-log subject=math-aa stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-dp-exp-log` |
| node_id | `math-ib-dp-exp-log` |
| 知识点 | 指数与对数（换底/方程） |
| 英文名 | Exponents and logarithms |
| 学科 | 数学 AA (math-aa) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

...
<!-- TeachAny KP: kp_id=kp-humanities-cam-igcse-argument-structure node_id=humanities-cam-igcse-argument-structure subject=global-persp stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-humanities-cam-igcse-argument-structure` |
| node_id | `humanities-cam-igcse-argument-structure` |
| 知识点 | 论证结构 |
...
Candidates will be assessed on their ability to: ... compare and evaluate contrasting perspectives (AO1)

# 原子结构与发射光谱 / Structure of the atom

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-atomic-structure node_id=phy-ib-dp-atomic-structure subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-atomic-structure` |
| node_id | `phy-ib-dp-atomic-structure` |
| 知识点 | 原子结构与发射光谱 |
| 英文名 | Structure of the atom |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 12 |
| 课标系统 | IB 国际文凭 |

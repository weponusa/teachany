# C4 生态系统（食物链/能量流动/营养级） / C4 Ecosystems & conservation

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-ecosystems node_id=bio-ib-dp-ecosystems subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-ecosystems` |
| node_id | `bio-ib-dp-ecosystems` |
| 知识点 | C4 生态系统（食物链/能量流动/营养级） |
| 英文名 | C4 Ecosystems & conservation |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 12 |
| 课标系统 | IB 国际文凭 |

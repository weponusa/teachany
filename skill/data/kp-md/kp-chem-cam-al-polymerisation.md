# 18 聚合反应（加聚/缩聚） / 18 Polymerisation

<!-- TeachAny KP: kp_id=kp-chem-cam-al-polymerisation node_id=chem-cam-al-polymerisation subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-polymerisation` |
| node_id | `chem-cam-al-polymerisation` |
| 知识点 | 18 聚合反应（加聚/缩聚） |
| 英文名 | 18 Polymerisation |
| 学科 | 化学 (chemistry) |

# 封装与访问修饰 / Encapsulation

<!-- TeachAny KP: kp_id=kp-cs-ap-a-encapsulation node_id=cs-ap-a-encapsulation subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-encapsulation` |
| node_id | `cs-ap-a-encapsulation` |
| 知识点 | 封装与访问修饰 |
| 英文名 | Encapsulation |
| 学科 | 计算机科学 (cs) |
| 学段 | 高中 (high) |

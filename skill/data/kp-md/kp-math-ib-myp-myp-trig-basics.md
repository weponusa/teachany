...
<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-trig-basics node_id=math-ib-myp-myp-trig-basics subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-trig-basics` |
| node_id | `math-ib-myp-myp-trig-basics` |
| 知识点 | 三角比 |
| 英文名 | Trigonometric ratios |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
| 年级 | 10 |
| 课标系统 | IB 国际文凭 |

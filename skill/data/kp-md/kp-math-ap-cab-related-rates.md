...
<!-- TeachAny KP: kp_id=kp-math-ap-cab-related-rates node_id=math-ap-cab-related-rates subject=calculus-ab stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-cab-related-rates` |
...
3.1 The Chain Rule 1.C Identify an appropriate mathematical

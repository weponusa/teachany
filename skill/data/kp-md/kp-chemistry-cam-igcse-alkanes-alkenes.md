# 烷烃与烯烃 / Alkanes & alkenes

<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-alkanes-alkenes node_id=chemistry-cam-igcse-alkanes-alkenes subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-alkanes-alkenes` |
| node_id | `chemistry-cam-igcse-alkanes-alkenes` |
| 知识点 | 烷烃与烯烃 |
| 英文名 | Alkanes & alkenes |
| 学科 | 化学 (chemistry) |

...
<!-- TeachAny KP: kp_id=kp-physics-ap-c-potential-energy node_id=physics-ap-c-potential-energy subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-potential-energy` |
| node_id | `physics-ap-c-potential-energy` |
| 知识点 | 势能函数 |
| 英文名 | Potential energy function |
| 学科 | 物理 C (physics-c) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 美国大学先修 |

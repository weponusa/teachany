...
<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-powers-roots node_id=math-ib-myp-myp-powers-roots subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-powers-roots` |
| node_id | `math-ib-myp-myp-powers-roots` |
| 知识点 | 幂与根 |
| 英文名 | Powers & roots |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
...
(a+b)2−a2−b2
International-mindedness: The Babylonian method of multiplication: ab= . Sulba Sutras in ancient India and the Bakhshali Manuscript contained an algebraic formula for solving quadratic equations.

# B3 运输（循环/运输，HL） / B3 Transport (HL)

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-transport-hl node_id=bio-ib-dp-transport-hl subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-transport-hl` |
| node_id | `bio-ib-dp-transport-hl` |
| 知识点 | B3 运输（循环/运输，HL） |
| 英文名 | B3 Transport (HL) |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |

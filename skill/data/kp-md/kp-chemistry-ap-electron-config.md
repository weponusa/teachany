...
<!-- TeachAny KP: kp_id=kp-chemistry-ap-electron-config node_id=chemistry-ap-electron-config subject=chemistry stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-ap-electron-config` |
| node_id | `chemistry-ap-electron-config` |
| 知识点 | 电子排布 |
| 英文名 | Electron configuration |
| 学科 | 化学 (chemistry) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

# 狭义相对论（HL） / Galilean & special relativity (HL)

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-special-relativity-hl node_id=phy-ib-dp-special-relativity-hl subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-special-relativity-hl` |
| node_id | `phy-ib-dp-special-relativity-hl` |
| 知识点 | 狭义相对论（HL） |
| 英文名 | Galilean & special relativity (HL) |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 12 |
| 课标系统 | IB 国际文凭 |

# 24 核物理（结合能/放射性/半衰期） / 24 Nuclear physics

<!-- TeachAny KP: kp_id=kp-phy-cam-al-nuclear-physics node_id=phy-cam-al-nuclear-physics subject=physics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-cam-al-nuclear-physics` |
| node_id | `phy-cam-al-nuclear-physics` |
| 知识点 | 24 核物理（结合能/放射性/半衰期） |
| 英文名 | 24 Nuclear physics |
| 学科 | 物理 (physics) |

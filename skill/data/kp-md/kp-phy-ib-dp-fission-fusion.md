# 核裂变与聚变 / Fission & fusion

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-fission-fusion node_id=phy-ib-dp-fission-fusion subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-fission-fusion` |
| node_id | `phy-ib-dp-fission-fusion` |
| 知识点 | 核裂变与聚变 |
| 英文名 | Fission & fusion |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |

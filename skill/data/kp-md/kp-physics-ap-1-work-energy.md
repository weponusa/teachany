...
<!-- TeachAny KP: kp_id=kp-physics-ap-1-work-energy node_id=physics-ap-1-work-energy subject=physics-1 stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-1-work-energy` |

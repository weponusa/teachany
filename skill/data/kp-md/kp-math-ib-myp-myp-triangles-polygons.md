# 三角形与多边形 / Triangles & polygons

<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-triangles-polygons node_id=math-ib-myp-myp-triangles-polygons subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-triangles-polygons` |
| node_id | `math-ib-myp-myp-triangles-polygons` |
| 知识点 | 三角形与多边形 |
| 英文名 | Triangles & polygons |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
| 年级 | 7 |
| 课标系统 | IB 国际文凭 |

# D2 有丝分裂与细胞周期 / D2 Cell & nuclear division

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-cell-cycle node_id=bio-ib-dp-cell-cycle subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-cell-cycle` |
| node_id | `bio-ib-dp-cell-cycle` |
| 知识点 | D2 有丝分裂与细胞周期 |
| 英文名 | D2 Cell & nuclear division |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

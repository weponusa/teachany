...
<!-- TeachAny KP: kp_id=kp-math-ap-bc-taylor-series node_id=math-ap-bc-taylor-series subject=calculus stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-bc-taylor-series` |
| node_id | `math-ap-bc-taylor-series` |
| 知识点 | 泰勒级数 |
| 英文名 | Taylor series |
| 学科 | 微积分 (calculus) |
| 学段 | 高中 (high) |

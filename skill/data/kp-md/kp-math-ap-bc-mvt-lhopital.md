# 中值定理与洛必达 / MVT & L'Hôpital

<!-- TeachAny KP: kp_id=kp-math-ap-bc-mvt-lhopital node_id=math-ap-bc-mvt-lhopital subject=calculus stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-bc-mvt-lhopital` |
| node_id | `math-ap-bc-mvt-lhopital` |
| 知识点 | 中值定理与洛必达 |
| 英文名 | MVT & L'Hôpital |
| 学科 | 微积分 (calculus) |
| 学段 | 高中 (high) |
...
differentiable functions. differentiation using derivative rules.

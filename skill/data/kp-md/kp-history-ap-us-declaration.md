...
<!-- TeachAny KP: kp_id=kp-history-ap-us-declaration node_id=history-ap-us-declaration subject=us-history stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-history-ap-us-declaration` |
| node_id | `history-ap-us-declaration` |
| 知识点 | 独立宣言 |
| 英文名 | Declaration of Independence |
| 学科 | 美国历史 (us-history) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

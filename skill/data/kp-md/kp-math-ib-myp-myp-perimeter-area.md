...
<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-perimeter-area node_id=math-ib-myp-myp-perimeter-area subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-perimeter-area` |
| node_id | `math-ib-myp-myp-perimeter-area` |
| 知识点 | 周长与面积 |
| 英文名 | Perimeter & area |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |

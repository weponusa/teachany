# B3 气体交换（呼吸系统） / B3 Gas exchange

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-gas-exchange node_id=bio-ib-dp-gas-exchange subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-gas-exchange` |
| node_id | `bio-ib-dp-gas-exchange` |
| 知识点 | B3 气体交换（呼吸系统） |
| 英文名 | B3 Gas exchange |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |

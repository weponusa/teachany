...
<!-- TeachAny KP: kp_id=kp-english-cam-al-text-comparison node_id=english-cam-al-text-comparison subject=english stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-cam-al-text-comparison` |
| node_id | `english-cam-al-text-comparison` |
| 知识点 | 文本比较 |
| 英文名 | Text comparison |
| 学科 | 英语 (english) |

# 圆盘法体积 / Volume by disks

<!-- TeachAny KP: kp_id=kp-math-ap-cab-volume-disk node_id=math-ap-cab-volume-disk subject=calculus-ab stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-cab-volume-disk` |

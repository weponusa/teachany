...
<!-- TeachAny KP: kp_id=kp-physics-ap-c-center-mass node_id=physics-ap-c-center-mass subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-center-mass` |
| node_id | `physics-ap-c-center-mass` |
| 知识点 | 质心运动 |
| 英文名 | Center of mass |
| 学科 | 物理 C (physics-c) |
| 学段 | 高中 (high) |

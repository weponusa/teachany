...
<!-- TeachAny KP: kp_id=kp-phy-ib-dp-standing-waves-resonance node_id=phy-ib-dp-standing-waves-resonance subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-standing-waves-resonance` |
| node_id | `phy-ib-dp-standing-waves-resonance` |
| 知识点 | 驻波与共振 |
| 英文名 | Standing waves and resonance |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

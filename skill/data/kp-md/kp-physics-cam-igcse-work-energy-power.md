# 功、能、功率 / Work, energy, power

<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-work-energy-power node_id=physics-cam-igcse-work-energy-power subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-work-energy-power` |
| node_id | `physics-cam-igcse-work-energy-power` |
| 知识点 | 功、能、功率 |
| 英文名 | Work, energy, power |
| 学科 | 物理 (physics) |
...
5 Determine, qualitatively, from given data or the shape of a distance–time graph or speed–time

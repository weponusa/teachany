...
<!-- TeachAny KP: kp_id=kp-math-cam-igcse-number-types node_id=math-cam-igcse-number-types subject=math stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-igcse-number-types` |
| node_id | `math-cam-igcse-number-types` |
| 知识点 | 数的类型 |
| 英文名 | Number types |
| 学科 | 数学 (math) |

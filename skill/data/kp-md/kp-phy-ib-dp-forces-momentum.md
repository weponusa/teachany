# 力与动量（牛顿定律/冲量/守恒） / Forces and momentum

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-forces-momentum node_id=phy-ib-dp-forces-momentum subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-forces-momentum` |
| node_id | `phy-ib-dp-forces-momentum` |
| 知识点 | 力与动量（牛顿定律/冲量/守恒） |
| 英文名 | Forces and momentum |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

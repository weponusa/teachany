...
<!-- TeachAny KP: kp_id=kp-physics-ap-1-angular-momentum node_id=physics-ap-1-angular-momentum subject=physics-1 stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-1-angular-momentum` |

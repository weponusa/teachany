# C3 稳态（激素/体温/血糖） / C3 Integration of body systems

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-homeostasis node_id=bio-ib-dp-homeostasis subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-homeostasis` |
| node_id | `bio-ib-dp-homeostasis` |
| 知识点 | C3 稳态（激素/体温/血糖） |
| 英文名 | C3 Integration of body systems |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

# 过程与函数 / Procedures & functions

<!-- TeachAny KP: kp_id=kp-cs-cam-igcse-subroutines node_id=cs-cam-igcse-subroutines subject=cs stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-cam-igcse-subroutines` |
| node_id | `cs-cam-igcse-subroutines` |
| 知识点 | 过程与函数 |
| 英文名 | Procedures & functions |
| 学科 | 计算机科学 (cs) |

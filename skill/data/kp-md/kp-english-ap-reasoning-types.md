# 推理类型 / Types of reasoning

<!-- TeachAny KP: kp_id=kp-english-ap-reasoning-types node_id=english-ap-reasoning-types subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-reasoning-types` |
| node_id | `english-ap-reasoning-types` |
| 知识点 | 推理类型 |
| 英文名 | Types of reasoning |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

...
<!-- TeachAny KP: kp_id=kp-phy-ib-dp-shm node_id=phy-ib-dp-shm subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-shm` |
| node_id | `phy-ib-dp-shm` |
| 知识点 | 简谐运动（SHM） |

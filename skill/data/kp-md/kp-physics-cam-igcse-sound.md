...
<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-sound node_id=physics-cam-igcse-sound subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-sound` |
| node_id | `physics-cam-igcse-sound` |
| 知识点 | 声 |
| 英文名 | Sound |
| 学科 | 物理 (physics) |

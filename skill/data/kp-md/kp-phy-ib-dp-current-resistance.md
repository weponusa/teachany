# 电流、电阻与电路 / Current and circuits

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-current-resistance node_id=phy-ib-dp-current-resistance subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-current-resistance` |
| node_id | `phy-ib-dp-current-resistance` |
| 知识点 | 电流、电阻与电路 |
| 英文名 | Current and circuits |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

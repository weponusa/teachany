...
<!-- TeachAny KP: kp_id=kp-humanities-cam-igcse-climate-gp node_id=humanities-cam-igcse-climate-gp subject=global-persp stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-humanities-cam-igcse-climate-gp` |
| node_id | `humanities-cam-igcse-climate-gp` |
| 知识点 | 气候变化 |
| 英文名 | Climate change |

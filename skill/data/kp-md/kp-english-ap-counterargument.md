# 反驳与回应 / Counterargument & concession

<!-- TeachAny KP: kp_id=kp-english-ap-counterargument node_id=english-ap-counterargument subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-counterargument` |
| node_id | `english-ap-counterargument` |
| 知识点 | 反驳与回应 |
| 英文名 | Counterargument & concession |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

# M1.2 力与平衡（力分解/摩擦） / M1.2 Forces & equilibrium

<!-- TeachAny KP: kp_id=kp-math-cam-al-forces-equilibrium node_id=math-cam-al-forces-equilibrium subject=math stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-al-forces-equilibrium` |
| node_id | `math-cam-al-forces-equilibrium` |
| 知识点 | M1.2 力与平衡（力分解/摩擦） |
| 英文名 | M1.2 Forces & equilibrium |
| 学科 | 数学 (math) |

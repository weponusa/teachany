...
<!-- TeachAny KP: kp_id=kp-physics-ap-1-gravitation node_id=physics-ap-1-gravitation subject=physics-1 stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-1-gravitation` |
| node_id | `physics-ap-1-gravitation` |
| 知识点 | 万有引力 |
| 英文名 | Gravitation |
| 学科 | 物理 1 (physics-1) |
| 学段 | 高中 (high) |

# 引用与格式 / Citation (MLA/APA)

<!-- TeachAny KP: kp_id=kp-english-ap-citation node_id=english-ap-citation subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-citation` |
| node_id | `english-ap-citation` |
| 知识点 | 引用与格式 |
| 英文名 | Citation (MLA/APA) |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 美国大学先修 |

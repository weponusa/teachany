# 论点陈述 / Thesis statements

<!-- TeachAny KP: kp_id=kp-english-ap-thesis-statements node_id=english-ap-thesis-statements subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-thesis-statements` |
| node_id | `english-ap-thesis-statements` |
| 知识点 | 论点陈述 |
| 英文名 | Thesis statements |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

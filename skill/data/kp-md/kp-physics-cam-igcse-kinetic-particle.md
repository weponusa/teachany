# 分子动理论 / Kinetic particle model

<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-kinetic-particle node_id=physics-cam-igcse-kinetic-particle subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-kinetic-particle` |
| node_id | `physics-cam-igcse-kinetic-particle` |
| 知识点 | 分子动理论 |
| 英文名 | Kinetic particle model |
| 学科 | 物理 (physics) |
| 学段 | Cambridge-IGCSE（初中/高中） (igcse) |
| 年级 | 9 |
| 课标系统 | Cambridge 剑桥国际 |
| 领域 | 热学 / Thermal Physics / Thermal Physics |

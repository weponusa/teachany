# A1 核酸（DNA/RNA 结构与复制） / A1 Nucleic acids

<!-- TeachAny KP: kp_id=kp-bio-ib-dp-nucleic-acids node_id=bio-ib-dp-nucleic-acids subject=biology stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-bio-ib-dp-nucleic-acids` |
| node_id | `bio-ib-dp-nucleic-acids` |
| 知识点 | A1 核酸（DNA/RNA 结构与复制） |
| 英文名 | A1 Nucleic acids |
| 学科 | 生物 (biology) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

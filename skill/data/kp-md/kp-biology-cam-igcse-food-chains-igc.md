# 食物链与能量流 / Food chains & energy

<!-- TeachAny KP: kp_id=kp-biology-cam-igcse-food-chains-igc node_id=biology-cam-igcse-food-chains-igc subject=biology stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-igcse-food-chains-igc` |
| node_id | `biology-cam-igcse-food-chains-igc` |
| 知识点 | 食物链与能量流 |
| 英文名 | Food chains & energy |
| 学科 | 生物 (biology) |
...
3 Describe the functions of the following components of blood:

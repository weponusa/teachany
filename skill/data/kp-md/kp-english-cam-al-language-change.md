...
<!-- TeachAny KP: kp_id=kp-english-cam-al-language-change node_id=english-cam-al-language-change subject=english stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-cam-al-language-change` |
| node_id | `english-cam-al-language-change` |
| 知识点 | 语言变迁 |
| 英文名 | Language change |
| 学科 | 英语 (english) |

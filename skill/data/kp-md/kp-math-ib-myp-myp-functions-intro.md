# 函数入门 / Intro functions

<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-functions-intro node_id=math-ib-myp-myp-functions-intro subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-functions-intro` |
| node_id | `math-ib-myp-myp-functions-intro` |
| 知识点 | 函数入门 |
| 英文名 | Intro functions |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
...
Use of the formulae for the nth term and the sum of
ways.
the first n terms of the sequence.
If technology is used in examinations, students will
Use of sigma notation for sums of arithmetic
be expected to identify the first term and the
sequences.
common difference.
...
differences.
model is not perfectly arithmetic in real life.

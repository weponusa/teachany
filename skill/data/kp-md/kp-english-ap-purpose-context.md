# 目的与语境 / Purpose & context

<!-- TeachAny KP: kp_id=kp-english-ap-purpose-context node_id=english-ap-purpose-context subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-purpose-context` |
| node_id | `english-ap-purpose-context` |
| 知识点 | 目的与语境 |
| 英文名 | Purpose & context |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |

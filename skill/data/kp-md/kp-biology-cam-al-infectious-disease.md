...
<!-- TeachAny KP: kp_id=kp-biology-cam-al-infectious-disease node_id=biology-cam-al-infectious-disease subject=biology stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-al-infectious-disease` |
| node_id | `biology-cam-al-infectious-disease` |
| 知识点 | 传染病 |

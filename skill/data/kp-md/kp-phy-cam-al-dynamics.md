# 3 动力学（牛顿定律/动量） / 3 Dynamics

<!-- TeachAny KP: kp_id=kp-phy-cam-al-dynamics node_id=phy-cam-al-dynamics subject=physics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-cam-al-dynamics` |
| node_id | `phy-cam-al-dynamics` |
| 知识点 | 3 动力学（牛顿定律/动量） |
| 英文名 | 3 Dynamics |
| 学科 | 物理 (physics) |

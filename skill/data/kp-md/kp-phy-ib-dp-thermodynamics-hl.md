# 热力学第一/第二定律（HL） / Thermodynamics (HL)

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-thermodynamics-hl node_id=phy-ib-dp-thermodynamics-hl subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-thermodynamics-hl` |
| node_id | `phy-ib-dp-thermodynamics-hl` |
| 知识点 | 热力学第一/第二定律（HL） |
| 英文名 | Thermodynamics (HL) |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 12 |
| 课标系统 | IB 国际文凭 |

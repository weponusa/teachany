...
<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-motion-igcse node_id=physics-cam-igcse-motion-igcse subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-motion-igcse` |
| node_id | `physics-cam-igcse-motion-igcse` |
| 知识点 | 运动学 |
| 英文名 | Motion |
| 学科 | 物理 (physics) |
...
- `physics-cam-igcse-units-measurement`

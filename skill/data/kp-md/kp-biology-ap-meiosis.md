...
<!-- TeachAny KP: kp_id=kp-biology-ap-meiosis node_id=biology-ap-meiosis subject=biology stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-ap-meiosis` |
| node_id | `biology-ap-meiosis` |
| 知识点 | 减数分裂 |
| 英文名 | Meiosis |
| 学科 | 生物 (biology) |
| 学段 | 高中 (high) |

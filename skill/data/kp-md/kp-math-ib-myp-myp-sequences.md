...
<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-sequences node_id=math-ib-myp-myp-sequences subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-sequences` |
| node_id | `math-ib-myp-myp-sequences` |
| 知识点 | 数列 |
| 英文名 | Sequences |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
...
roots, that is, two distinct real roots, two equal real
roots, no real roots.

...
<!-- TeachAny KP: kp_id=kp-biology-cam-igcse-gas-exchange node_id=biology-cam-igcse-gas-exchange subject=biology stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-igcse-gas-exchange` |
| node_id | `biology-cam-igcse-gas-exchange` |
| 知识点 | 气体交换 |
| 英文名 | Gas exchange |
| 学科 | 生物 (biology) |

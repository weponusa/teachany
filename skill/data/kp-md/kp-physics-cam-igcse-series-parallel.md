# 串并联电路 / Series & parallel

<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-series-parallel node_id=physics-cam-igcse-series-parallel subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-series-parallel` |
| node_id | `physics-cam-igcse-series-parallel` |
| 知识点 | 串并联电路 |
| 英文名 | Series & parallel |
| 学科 | 物理 (physics) |
...
- `physics-cam-igcse-ohms-law`

## 课标摘要

1.2 Motion Core 1 Define speed as distance travelled per unit time; recall and use the equation s v = t 2 Define velocity as speed in a given direction 3 Recall and use the equation total distance travelled average speed = total time taken；1.2 Motion Core 4 Sketch, plot and interpret distance–time and speed–time graphs 5 Determine, qualitatively, from given data or the shape of a distance–time graph or speed–time graph when an object is: (a) at rest (b) moving with constant speed (c) accelerating (d) decelerating；1.2 Motion Supplement 9 Define acceleration as change in velocity per unit time; recall and use the equation ∆v a = ∆t；1.2 Motion Supplement 11 Calculate acceleration from the gradient of a speed–time graph 12 Know that a deceleration is a negative acceleration and use this in calculations

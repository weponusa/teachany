# 溶液与浓度 / Solutions & concentration

<!-- TeachAny KP: kp_id=kp-chemistry-ap-solutions node_id=chemistry-ap-solutions subject=chemistry stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-ap-solutions` |
| node_id | `chemistry-ap-solutions` |
| 知识点 | 溶液与浓度 |
| 英文名 | Solutions & concentration |
| 学科 | 化学 (chemistry) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 美国大学先修 |

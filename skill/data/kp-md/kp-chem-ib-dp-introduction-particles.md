# 物质的粒子本质与物态 / Introduction to particulate nature & states

<!-- TeachAny KP: kp_id=kp-chem-ib-dp-introduction-particles node_id=chem-ib-dp-introduction-particles subject=chemistry stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-ib-dp-introduction-particles` |
| node_id | `chem-ib-dp-introduction-particles` |
| 知识点 | 物质的粒子本质与物态 |
| 英文名 | Introduction to particulate nature & states |
| 学科 | 化学 (chemistry) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |

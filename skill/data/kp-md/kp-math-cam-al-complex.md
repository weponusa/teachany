# P3.9 复数（笛卡尔/极坐标/Argand 图） / P3.9 Complex numbers

<!-- TeachAny KP: kp_id=kp-math-cam-al-complex node_id=math-cam-al-complex subject=math stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-al-complex` |
| node_id | `math-cam-al-complex` |
| 知识点 | P3.9 复数（笛卡尔/极坐标/Argand 图） |
| 英文名 | P3.9 Complex numbers |
| 学科 | 数学 (math) |

...
<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-percentages node_id=math-ib-myp-myp-percentages subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-percentages` |
| node_id | `math-ib-myp-myp-percentages` |
| 知识点 | 百分数 |
| 英文名 | Percentages |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
...
- `math-ib-myp-myp-fractions-decimals`

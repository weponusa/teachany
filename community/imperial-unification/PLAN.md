# PLAN.md —— 秦汉统一多民族国家 策划文档

## 1. 教学骨架摘要（源自 Phase 1）

- **课件 ID**：imperial-unification
- **node_id**：imperial-unification
- **学段/学科**：history·7年级（初中历史七年级上册）
- **ABT 叙事**：已注入（见课件 #why-learn 区块）
- **Bloom 层级覆盖**：L1-L4 多层覆盖
- **ConcepTest 锚点**：秦制度+汉武帝+丝路
...
- [x] **知识图谱**：`data-teachany-kg="imperial-unification"` 已列入 M5

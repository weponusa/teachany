...
<head>
  ...
  <meta name="teachany-node" content="hist-h-science-technology-h">
  <meta name="teachany-subject" content="history">
  <meta name="teachany-grade" content="high">
  ...
  <title>四大发明与中国古代科技 · 高中历史 G10 · TeachAny v1.0.0</title>
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .image-panel {{ margin: 16px 0; text-align: center; }}
    .course-img {{ width: 100%; max-width: 820px; border-radius: 16px; box-shadow: 0 6px 22px rgba(76,29,149,0.14); border: 1px solid #e2e8f0; background: white; }}
    .map-panel {{ background: linear-gradient(135deg,#eef2ff,#f8fafc); border: 2px solid #c7d2fe; border-radius: 16px; padding: 16px; margin: 16px 0; }}
    .map-panel h4 {{ color: #3730a3; font-size: 1rem; margin-bottom: 10px; }}
    #inventionMap {{ height: 360px; border-radius: 14px; overflow: hidden; border: 1px solid #c7d2fe; background: #dbeafe; }}
    .fallback-map {{ position: relative; height: 100%; background: linear-gradient(135deg,#dbeafe,#f8fafc); }}
    .fallback-map svg {{ width: 100%; height: 100%; display: block; }}
    .map-fallback {{ display:none; margin-top:10px; font-size:0.88rem; color:#475569; line-height:1.6; }}
...
<!-- ===== 模块1: 四大发明详解 ===== -->
<div class="section module-section active" id="sec-mod1">
  <div class="card">
    <div class="tab-bar">
    ...
    <div class="image-panel">
      <img class="course-img" src="./assets/hist-h-four-great-inventions-route-map.png" alt="四大发明从中国经中亚与阿拉伯传向欧洲的传播路线图">
    </div>
    <div class="map-panel">
      <h4>互动地图：从中国到阿拉伯，再到欧洲</h4>
      <div id="inventionMap"></div>
      <div class="map-fallback" id="mapFallback">地图瓦片加载较慢时，可结合上方路线图理解：中国是发明地，阿拉伯世界是中转站，欧洲是变革地。</div>
    </div>
    <div class="route-svg">
...
<!-- ===== 模块2: 古代科技群星 ===== -->
<div class="section module-section" id="sec-mod2">
  <div class="card">
    <div class="tab-bar">
...
<!-- ===== 模块3: 李约瑟之问 ===== -->
<div class="section module-section" id="sec-mod3">
  <div class="card">
    <div class="tab-bar">
      <div class="tab" onclick="goToMod(1)">① 四大发明详解</div>
      <div class="tab" onclick="goToMod(2)">② 古代科技群星</div>
    ...
    <section id="knowledge-graph" class="kg-container">
      <h4>🧭 知识图谱：科技史中的四大发明</h4>
      <div data-teachany-kg="hist-h-science-technology-h"></div>
    </section>
